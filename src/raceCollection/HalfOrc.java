...
public class HalfOrc extends RaceMenu{
	...
	String alignment = "Half-orcs inherit a tendancy toward chaos from their orc parents and are not strongly inclined toward good. Half-orcs raised among orcs and willing to live out their lives among them are usually evil.";
	String size = "Half-orcs are somewhat larger and bulkier than humans, and they range from 5 to well over 6 feet tall. Your size is Medium.";
	String speed = "Your base walking speed is 30 feet.";
	String darkvision = "Thanks to your orc blood you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light. You can't discern color in darkness, only shades of gray";
